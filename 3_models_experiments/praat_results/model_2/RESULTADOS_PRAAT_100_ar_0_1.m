clear all
%close all
load resultados_senales_ar_100Hz_0_1_1MOD.mat
load resultados_PRAAT_senales_ar_100Hz_0_1.mat

jitterPRAAT=jitter_PRAAT_ar_100_0_1';
...
savefig('ba_PRAAT_ar_100_0_1.fig');
%close all
